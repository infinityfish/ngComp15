  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.times.findById() instead.
        "prototype$__findById__times": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Users/:id/times/:fk",
          method: "GET"
        },

        // INTERNAL. Use User.times.destroyById() instead.
        "prototype$__destroyById__times": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Users/:id/times/:fk",
        ...
        // INTERNAL. Use User.times.updateById() instead.
        "prototype$__updateById__times": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Users/:id/times/:fk",
        ...
        // INTERNAL. Use User.times() instead.
        "prototype$__get__times": {
          isArray: true,
          url: urlBase + "/Users/:id/times",
          method: "GET"
        },

        // INTERNAL. Use User.times.create() instead.
        "prototype$__create__times": {
          url: urlBase + "/Users/:id/times",
          method: "POST"
        },

        // INTERNAL. Use User.times.destroyAll() instead.
        "prototype$__delete__times": {
          url: urlBase + "/Users/:id/times",
          method: "DELETE"
        },

        // INTERNAL. Use User.times.count() instead.
        "prototype$__count__times": {
          url: urlBase + "/Users/:id/times/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.User.times
     * @header lbServices.User.times
     * @object
     * @description
     *
     * The object `User.times` groups methods
     * manipulating `Time` instances related to `User`.
     *
     * Call {@link lbServices.User#times User.times()}
     * to query all related instances.
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Time` object.)
         * </em>
         */
        R.times = function() {
          var TargetResource = $injector.get("Time");
          var action = TargetResource["::get::User::times"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.times#count
         * @methodOf lbServices.User.times
         *
         * @description
         *
         * Counts times of User.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         *  - `count` – `{number=}` - 
         */
        R.times.count = function() {
          var TargetResource = $injector.get("Time");
          var action = TargetResource["::count::User::times"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.times#create
         * @methodOf lbServices.User.times
         *
         * @description
         *
         * Creates a new instance in times of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.times.create = function() {
          var TargetResource = $injector.get("Time");
          var action = TargetResource["::create::User::times"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.times#createMany
         * @methodOf lbServices.User.times
         *
         * @description
         *
         ...
         * </em>
         */
        R.times.createMany = function() {
          var TargetResource = $injector.get("Time");
          var action = TargetResource["::createMany::User::times"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.times#destroyAll
         * @methodOf lbServices.User.times
         *
         * @description
         *
         * Deletes all times of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.times.destroyAll = function() {
          var TargetResource = $injector.get("Time");
          var action = TargetResource["::delete::User::times"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.times#destroyById
         * @methodOf lbServices.User.times
         *
         * @description
         *
         * Delete a related item by id for times.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         *
         *  - `fk` – `{*}` - Foreign key for times
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.times.destroyById = function() {
          var TargetResource = $injector.get("Time");
          var action = TargetResource["::destroyById::User::times"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.times#findById
         * @methodOf lbServices.User.times
         *
         * @description
         *
         * Find a related item by id for times.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.times.findById = function() {
          var TargetResource = $injector.get("Time");
          var action = TargetResource["::findById::User::times"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.times#updateById
         * @methodOf lbServices.User.times
         *
         * @description
         *
         * Update a related item by id for times.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.times.updateById = function() {
          var TargetResource = $injector.get("Time");
          var action = TargetResource["::updateById::User::times"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Time
 * @header lbServices.Time
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Time` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Time#create
         * @methodOf lbServices.Time
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
        ...
        /**
         * @ngdoc method
         * @name lbServices.Time#createMany
         * @methodOf lbServices.Time
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Times/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Time#findById
         * @methodOf lbServices.Time
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/Times/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Time#find
         * @methodOf lbServices.Time
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Times/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Time#updateAll
         * @methodOf lbServices.Time
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Times/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Time#deleteById
         * @methodOf lbServices.Time
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Times/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Time#prototype$updateAttributes
         * @methodOf lbServices.Time
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Time#createChangeStream
         * @methodOf lbServices.Time
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/Times/change-stream",
          method: "POST"
        },
        ...
        // INTERNAL. Use User.times.createMany() instead.
        "::createMany::User::times": {
          isArray: true,
          url: urlBase + "/Users/:id/times",
          method: "POST"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Time#updateOrCreate
         * @methodOf lbServices.Time
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Time#destroyById
         * @methodOf lbServices.Time
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Time#removeById
         * @methodOf lbServices.Time
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Time#modelName
    * @propertyOf lbServices.Time
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Time`.
    */
